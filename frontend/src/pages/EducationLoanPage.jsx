    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: "Interest Rate Starts from", value: "9% p.a." },
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {loanTypes.map((type, idx) => (
              <div key={idx} className="bg-white p-8 rounded-2xl shadow-xl">
                <h3 className="text-2xl font-bold mb-3" style={{ color: '#003a77' }}>{type.title}</h3>
                <p className="text-3xl font-bold mb-6" style={{ color: '#003a77' }}>{type.amount}</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {coverageItems.map((item, idx) => (
            <div key={idx} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all text-center">
              ...
              <h3 className="text-lg font-bold mb-2" style={{ color: '#f97316' }}>{item.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {popularDestinations.map((dest, idx) => (
              <div key={idx} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all text-center">
                <h3 className="text-2xl font-bold mb-2 text-[#f97316]">{dest.country}</h3>
        ...
        <div className="grid md:grid-cols-4 gap-4">
          {courses.map((course, idx) => (
            <div key={idx} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all text-center border-2" style={{ borderColor: 'rgba(0, 44, 96, 0.1)' }}>
              <CheckCircle className="w-8 h-8 mx-auto mb-3" style={{ color: '#f97316' }} />
              <p className="font-semibold" style={{ color: '#003a77' }}>{course}</p>
            </div>
          ))}
        </div>
      </div> */}
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all">
              <h3 className="text-lg font-bold mb-2" style={{ color: '#f97316' }}>{feature.title}</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="rounded-3xl p-8 md:p-12 text-center text-white shadow-2xl" style={{ background: 'linear-gradient(135deg, #003a77 0%, #004080 100%)' }}>
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#f97316]">Ready to Pursue Your Dreams?</h2>
          <p className="text-lg md:text-xl mb-8 opacity-90">
